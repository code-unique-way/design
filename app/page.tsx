...
import Footer from "@/New folder/app/components/Footer"
...
export default function Home() {
  ...
  return (
   ...
   <ProductShowcase/>
    ...
    <div
      className={`min-h-screen  flex items-center justify-center p-8 ${ppEditorialNewUltralightItalic.variable} ${inter.variable}`}
     >
